...
import { 
    AlvinMoy, ChaseJankowski, DaniellePerkins, ElleHamilton, JasonDieckhaus,
    JasonXu, JoshuaKroft, KarthikThallam, LaurenHiggins, MarcellaTebeau,
    MatthewMartin, NathanDerucki, ReaganRandolph, SayamGupta, ShrijaMaganti,
    ShyamPatel, TylerSanford, VishaanthMuddu, EricWong, EverettYan, JadaCastile
} from './Images';
...
export const Members: IMember[] = [
    ...
    },
    {
        ...
        role: 'Logistics Lead',
        avatar: ShrijaMaganti.src 
    },
    {
        name: 'Lauren Higgins',
        linkedin: 'https://www.linkedin.com/in/higgins7loh/',
        role: 'Design Lead',
        avatar: LaurenHiggins.src  
    },
    {
        name: 'Jason Xu',
