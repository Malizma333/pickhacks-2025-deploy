  ...
  return (
    <>
      ...
      <div
        ...
        style={{ opacity: open ? 1 : 0, zIndex: open ? 98 : 0 }}
      >
        ...
        <div className={styles.socials}>
          <a
            className={styles.icon}
            href="https://pickhacks-2025mst.devpost.com/"
            target="_blank"
          >
            <img src={devpost.src} />
          </a>
          ...
          <a
            className={styles.icon}
            href="https://discord.gg/weJVRv4Rk9"
            target="_blank"
          >
            <img src={discord.src} />
          </a>
          ...
          <a
            className={styles.icon}
            href="https://www.tiktok.com/@sandtpickhacks"
            target="_blank"
          >
            <img src={tiktok.src} />
          </a>
